...
list within Common Lisp can contain a username, a password, the user's access level or it could contain your first name, your last name, your address...etc... pretty much
anything you want it to hold. If we want to have Common Lisp **only** access a certain portion of that data, we need a way to direct Common Lisp to *only* access that data
within the list! Common Lisp has two functions, CAR and CDR (you'll see that they're actually expandable into more than two in a moment!) to do just that!
  
## CAR, CDR....wait a minute, what?!

  CAR and CDR go back to the beginning of Lisp. When John McCarthy was designing Lisp as it's own language, rather than as an add on to Fortran, he had an [IBM 704](https://www.computerhistory.org/chess/stl-431614f6482e6/) 
...
the ability to access a field directly by requesting it through the CAR or CDR command.
  ...
  of London, in fact, his paper [is online](https://arxiv.org/ftp/arxiv/papers/1507/1507.05956.pdf) and is a great, in depth discussion of CAR and CDR if you want to read
...
We call our value \*personel\*  with the asterisks on both sides because we want it to be a global variable, something we can access anywhere in our code. If you remember, I 
